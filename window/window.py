...
class window_templ:
    ...
    def __init__(self, points, shapes, distance=5, scale=10, width: int = 1000, height: int = 600, title: str = '3D Scene',
        ...
        self.window.bind('<ButtonRelease-1>', self.engine.reset_event)
        ...
        self.l = Listbox(self.selection_panel, selectmode=EXTENDED, height=30, yscrollcommand=self.scrollbar.set)
        ...
        self.scale_up_button = Button(self.scale_controls_steps, text='▲', command=self.change_scale_step_size_up, repeatdelay=500,
                                 repeatinterval=25)
        ...
        self.scale_down_button = Button(self.scale_controls_steps, text='▼', command=self.change_scale_step_size_down, repeatdelay=500,
                                   repeatinterval=25)
        ...
        self.translation_up_button = Button(self.translation_controls_steps, text='▲', command=self.change_translation_step_size_up,
                                       repeatdelay=500,
                                       repeatinterval=50)
        ...
        self.translation_down_button = Button(self.translation_controls_steps, text='▼', command=self.change_translation_step_size_down,
        ...
        self.backward_button = Button(self.translate_control_supper, text='⟱', command=self.backward,
                                 repeatdelay=500, repeatinterval=50)
        self.backward_button.pack(side='left')

        self.up_button = Button(self.translate_control_supper, text='↑', command=self.up, repeatdelay=500, repeatinterval=50)
        self.up_button.pack(side='left')

        self.forward_button = Button(self.translate_control_supper, text='⟰', command=self.forward, repeatdelay=500, repeatinterval=50)
        self.forward_button.pack(side='left')

        self.leftButton = Button(self.translate_controls_lower, text='←', command=self.left, repeatdelay=500, repeatinterval=50)
        self.leftButton.pack(side='left')

        self.up_button = Button(self.translate_controls_lower, text='↓', command=self.down, repeatdelay=500, repeatinterval=50)
        self.up_button.pack(side='left')

        self.right_button = Button(self.translate_controls_lower, text='→', command=self.right, repeatdelay=500, repeatinterval=50)
        ...
        self.rotation_up_button = Button(self.rotation_controls_steps, text='▲', command=self.change_rotation_step_size_up, repeatdelay=500,
                                    repeatinterval=50)
        ...
        self.rotation_down_button = Button(self.rotation_controls_steps, text='▼', command=self.change_rotation_step_size_down,
                                      repeatdelay=500,
                                      repeatinterval=50)
        ...
        self.x_plus_button = Button(self.rotation_controls_x, text='X+', command=self.x_plus, repeatdelay=500, repeatinterval=50)
        self.x_plus_button.pack(side='top')

        self.x_minus_button = Button(self.rotation_controls_x, text='X-', command=self.x_sub, repeatdelay=500, repeatinterval=50)
        self.x_minus_button.pack(side='bottom')

        self.y_plus_button = Button(self.rotation_controls_y, text='Y+', command=self.y_plus, repeatdelay=500, repeatinterval=50)
        self.y_plus_button.pack(side='top')

        self.y_minus_button = Button(self.rotation_controls_y, text='Y-', command=self.y_sub, repeatdelay=500, repeatinterval=50)
        self.y_minus_button.pack(side='bottom')

        self.z_plus_button = Button(self.rotation_controls_z, text='Z+', command=self.z_plus, repeatdelay=500, repeatinterval=50)
        self.z_plus_button.pack(side='top')

        self.z_minus_button = Button(self.rotation_controls_z, text='Z-', command=self.z_sub, repeatdelay=500, repeatinterval=50)
